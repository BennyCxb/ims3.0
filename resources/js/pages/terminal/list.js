define(function (require, exports, module) {
    ...
    function selectLanguage() {
        ...
        $("#term_search").attr("placeholder", languageJSON.search);
                ...
                if (tl.length != 0) {
                    for (var i = 0; i < tl.length; i++) {
                        ...
                        $('#term_list').append('' +
                            ...
                            snap + '<button style=" position:relative; margin-top:-16px;" class="log btn btn-default btn-xs pull-right"><a style="font-size:12px; color:#333" title="' + languageJSON.list_queryLog + '"><i class="fa fa-file-text-o"></i></a></button>' + '</br>' +
                            ...
                            UTIL.ajax(
                                ...
                                function (data) {
                                    ...
                                    if (data.rescode == '200') {
                                        ...
                                        alert(languageJSON.al_addCfFaild);
                                        input.focus();
                                    }
                                }
                            );
                                    ...
                                    UTIL.ajax(
                                        ...
                                        function (data) {
                                            if (data.rescode == '200') {
                                                ...
                                                alert(languageJSON.al_deleteRootF);
                                                input.focus();
                                            }
                                        }
                                    );
                                ...
                                UTIL.ajax(
                                    ...
                                    function (data) {
                                        ...
                                        if (data.rescode == '200') {
                                            ...
                                            alert(languageJSON.al_editRootF);
                                            input.focus();
                                        }
                                    }
                                );
